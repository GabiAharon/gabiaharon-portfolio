...
(לחץ אישור כדי לתרגם, ביטול כדי להשאיר ללא שינוי)`);
  ...
  return (
    <div className={`min-h-screen w-full bg-gradient-to-b from-slate-950 via-gray-950 to-black text-white ${language === 'he' ? 'rtl' : 'ltr'}`}>
      {/* לוגו */}
          ...
          >
            <AnimatePresence>
              {testimonialsData.map((testimonial, index) => (
                ...
                >
                  <div className={`${editingTestimonial === testimonial.id ? 'bg-gradient-to-r from-slate-600 to-slate-700' : 'bg-gradient-to-r from-slate-700 to-blue-900'} p-0.5 rounded-xl h-full`}>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {certificatesData.map((certificate, index) => (
                <motion.div
                  ...
                  className="group"
                >
                  <div className="bg-gradient-to-r from-slate-700 to-blue-900 p-0.5 rounded-lg hover:from-slate-600 hover:to-blue-800 transition-all duration-300">
