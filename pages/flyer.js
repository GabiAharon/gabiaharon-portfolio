...
export default function Flyer() {
  return (
    <Layout language="he">
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black rtl">
                ...
                <div className="order-1 md:order-2 text-white">
                  ...
                  <div className="space-y-4">
                    ...
                    <a 
                      ...
                      className="w-full bg-gradient-to-r from-slate-700 to-slate-800 hover:from-slate-600 hover:to-slate-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 flex items-center justify-center gap-2"
                    >
